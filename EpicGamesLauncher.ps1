...
Write-Host "Checking for updates (Wanted)..." -ForegroundColor Cyan

$apiUrl = "https://api.github.com/repos/GRILLYje/Animal_Wanted_Public/releases/latest"
...
Write-Host "Launching Wanted..." -ForegroundColor Green
